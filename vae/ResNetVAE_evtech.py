...
def train(log_interval, model, device, train_loader, optimizer, epoch):
    ...
    return X_reconst.data.cpu().numpy(), all_z, all_mu, all_logvar, losses
...
for epoch in range(epochs):
    # train, test model
    X_reconst_train, z_train, mu_train, logvar_train, train_losses = train(log_interval, resnet_vae, device, train_loader, optimizer, epoch)
    X_reconst_test, z_test, mu_test, logvar_test, epoch_test_loss = validation(resnet_vae, device, optimizer, valid_loader)
